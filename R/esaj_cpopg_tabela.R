...
esaj_cpopg_baixar_tabela_processo <- function (processo = NULL, diretorio = ".", cookies_path = NULL) {
...
esaj_cpopg_baixar_tabela_cd_processo <- function (cd_processo = NULL, diretorio = ".") {
