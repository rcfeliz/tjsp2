#' Iteração da função tjsp_baixar_cpopg_outros_unitario()
#'
...
#' @examples
#' \dontrun{
#' tjsp_baixar_cpopg_outros(consultas = c("123456SP", "100000SP"), parametro = "NUMOAB")
#' tjsp_baixar_cpopg_outros(consultas = "José da Silva Pereira", parametro = "NMPARTE")
#'}
tjsp_baixar_cpopg_outros <- function(consultas = NULL, parametro = c("NMPARTE", "DOCPARTE", "NMADVOGADO", "NUMOAB", "PRECATORIA", "DOCDELEG", "NUMCDA"), diretorio = ".") {
  ...
  purrr::walk(consultas, ~{
    tjsp_baixar_cpopg_outros_unitario(consulta = .x, parametro = parametro)
...
#' @examples
#' \dontrun{
#' tjsp_baixar_cpopg_outros_unitario(consulta="123456SP", parametro = "NUMOAB")
#' tjsp_baixar_cpopg_outros_unitario(consulta = "José da Silva Pereira", parametro = "NMPARTE")
#'}
#'
#'
#' @details A estrutura do nome dos arquivos gerados é sempre ./{parametro}_{consulta}_{pagina}.html.
tjsp_baixar_cpopg_outros_unitario <- function(consulta = NULL, parametro = c("NMPARTE", "DOCPARTE", "NMADVOGADO", "NUMOAB", "PRECATORIA", "DOCDELEG", "NUMCDA"), diretorio = ".") {
